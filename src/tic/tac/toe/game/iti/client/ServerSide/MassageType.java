...
public class MassageType {
    ...
    public static final String RESTART_REQUEST_MSG = "restart req"; 
    public static final String RESTART_ACCEPT_MSG = "restart acc"; 
    public static final String RESTART_REJECT_MSG = "restart rej";
